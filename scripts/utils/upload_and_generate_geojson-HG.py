...
if __name__ == "__main__":
    ...
    OUT_FILENAME = "CoastAlRisk_Europe_EESSL.zarr"  # file name in the cloud and on MapBox
    VARIABLES = ["ssl"]  # what variable(s) do you want to show as marker color?
    ...
    ADDITIONAL_DIMENSIONS = ["scenarios", "rp"]
    ...
    MAP_SELECTION_DIMS = {
        "scenarios": ["Historical", "RCP45", "RCP85"],  # TODO: fix bug. If I put ["ssp126", "ssp245", "ssp585"] if doesn't work properly as nscenarios and scenarios are disconnected in the variable. If I put nscenarios = [0,1,2] (like for ensembles) I get an error because of the disconnection
        "rp": [   5.,   10.,   20.,   50.,  100.,  200.,  500., 1000.],
    }
